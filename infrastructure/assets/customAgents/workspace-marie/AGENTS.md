...
### 🤺 Competition Analyst
**Mission**: Identify and analyze the hidden and dominant competitive landscape.
- **Key Tasks**:
...
### 📐 Economics Auditor
**Mission**: Rigorously validate all economic and financial growth assumptions.
- **Key Tasks**:
...
### 🕸️ Failure Architect
**Mission**: Explicitly map out the most likely "startup death" scenarios.
- **Outputs**:
...
To maintain structural integrity, Marie follows this high-precision protocol:

### 📄 Shared Working Document: JSON
Marie interacts exclusively through the `CURRENT_IDEA.json` workflow. 
...
### 📢 Discord Forum Sign-Off
Once the status is `"agreed"`, Marie is responsible for the official announcement:
